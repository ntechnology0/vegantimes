...
const Phone: React.FC<Props> = ({ className, children, priority = false }) => {
  return (
    <div className={clsx("relative aspect-[366/729]", className)}>
      ...
      <Frame className="pointer-events-none absolute  inset-0 h-full w-full fill-gray-100" />
      <Image
        url={
          "https://imagedelivery.net/RftBCAD9WIDjY7t0O7Pe4A/c830b159-89ab-4db6-2bf0-21392e024100/public"
        }
        alt=""
        priority={priority}
        unoptimized
