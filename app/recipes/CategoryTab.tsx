...
const CategoryTab: React.FC = () => {
  return (
    <CategoryStyled className="w-full flex flex-col justify-start items-start py-3 px-6 lg:px-0">
      <div className="w-full flex flex-row lg:flex-row justify-between items-start lg:space-y-0 lg:pr-4">
        <h1 className="fonts__poppins_regular font-semibold text-xl">Categories</h1>
        <div className="flex flex-row justify-start items-center space-x-2">
          <Link href="/categories/new">
            ...
            >
              ...
              <span className="text-white text-xs">Add a category</span>
            </Button>
          </Link>
        </div>
      </div>
