...
const Sidebar: React.FC = () => {
  return (
    <SidebarStyled className="w-full fixed lg:relative lg:w-[240px] bg-white py-2 lg:space-y-1 space-y-0 lg:border-r border-b border-slate-100 lg:h-screen h-[50px] flex flex-row px-2 lg:px-4 lg:flex-col justify-between lg:justify-between items-end lg:items-start overflow-x-scroll lg:overflow-x-hidden">
